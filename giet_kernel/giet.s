 ...
 * the value of EPC on the kernel TTY, and the user program is killed.
 */
...
_sys_handler:
    addiu   $29,    $29,    -24     /* 2 slots for SR & EPC, 4 slots for args */
    mfc0    $27,    $14             /* $27 <= EPC                             */
    addiu   $27,    $27,    4       /* increment EPC for return address       */
    sw      $27,    20($29)         /* save EPC in the stack                  */
    mfc0    $27,    $12             /* $27 <= SR                              */
    sw      $27,    16($29)         /* save SR in the stack                   */
    ...
    mtc0    $0,     $12             /* SR <= 0 : interrupt disabled           */
    lw      $26,    16($29)         /* $26 <= SR from stack                   */
    mtc0    $26,    $12             /* restore SR                             */
    lw      $26,    20($29)         /* $26 <= EPC from stack                  */
