...
##################################################################################
#  This file describes the mapping of the multi-threaded "dhrystone" 
    ...
    for x in xrange (x_size):
        for y in xrange (y_size):
            ...
            if ( mapping.clusters[cluster_id].procs ):
                ...
                mapping.addVseg( vspace, 'dhry_code_%d_%d' %(x,y), 
                                 code_base , code_size,
        ...
        for y in xrange (y_size):
            ...
            if ( mapping.clusters[cluster_id].procs ):
                for p in xrange( nprocs ):
                    ...
                    mapping.addVseg( vspace, 'dhry_stack_%d_%d_%d' % (x,y,p), 
    ...
    for x in xrange (x_size):
        for y in xrange (y_size):
            ...
            if ( mapping.clusters[cluster_id].procs ):
                ...
                mapping.addVseg( vspace, 'dhry_heap_%d_%d' % (x,y), base, size, 
        ...
        for y in xrange (y_size):
            ...
            if ( mapping.clusters[cluster_id].procs ):
                for p in xrange( nprocs ):
                    ...
                    mapping.addTask( vspace, 'dhry_%d_%d_%d' % (x,y,p),
                                     trdid, x, y, p,
                                     'dhry_stack_%d_%d_%d' % (x,y,p),
                                     'dhry_heap_%d_%d' % (x,y), 0 )
